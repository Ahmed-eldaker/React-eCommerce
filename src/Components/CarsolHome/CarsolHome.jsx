              ...
              <div className="row container  ">
                <div className="col-md-6  ">
                  <div className="d-flex h-100 justify-content-center  flex-column  cursoltext ">
                    <h4 className="animate__animated animate__fadeInUpBig text-danger">
                      NEW PRODUCTS
                    </h4>
                    <h2 className="animate__animated animate__fadeInUpBig">
                      Electronics Items
                    </h2>
                    <p className="animate__animated animate__fadeInUpBig animate__slow">
                      Take a look at these seating essentials that will help you
                      <br /> Last call for upto 45%
                    </p>
                    <Link to="/allproducts">
                      <button className="btn1 btn btn-danger  w-25 animate__animated animate__fadeInUpBig animate__delay-1s">
                        Shop Now
                      </button>
                    </Link>
                  </div>
                ...
                <div className="col-md-6">
                  <div className="d-flex h-100 justify-content-center  flex-column  cursoltext ">
                    ...
                    <p className="animate__animated animate__fadeInUpBig animate__slow">
                      ...
                      <br /> get through your day with ease.
                    </p>
                    <Link to="/allproducts">
                      <button className="btn1 btn btn-danger w-25 animate__animated animate__fadeInUpBig animate__delay-1s">
                        Shop Now
